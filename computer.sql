...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Nov 25. 08:09
...
CREATE TABLE `comp` (
  ...
  `Brand` varchar(37) COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `Type` varchar(30) COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `Display` double DEFAULT NULL,
  `Memory` int(11) DEFAULT NULL,
  `CreatedTime` datetime DEFAULT NULL,
  `OsId` varchar(36) COLLATE utf8mb4_hungarian_ci DEFAULT NULL
...
--
ALTER TABLE `comp`
  ADD CONSTRAINT `comp_ibfk_1` FOREIGN KEY (`OsId`) REFERENCES `osystem` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
